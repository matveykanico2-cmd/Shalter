...
const TOPICS = [
  ...
  },
  {
    ...
    answer: () =>
      "🔐 Двухфакторная аутентификация — Настройки → Безопасность → «Двухфакторная аутентификация».\n\n" +
  ...
  },
  {
    ...
    answer: () =>
      "Удаление аккаунта — Настройки → Данные и память → «Удалить аккаунт». Понадобится пароль.\n\n" +
      "Это необратимо: удаляются профиль, сообщения и чаты. Перед удалением можно выгрузить свои данные одним файлом на той же странице.",
  },
  {
    id: "bots",
    ...
    answer: () =>
      ...
      "Если хотите держать бота у себя, есть обычный Bot API с токеном и получением обновлений — описание на странице /BOTS.md.",
  },
  {
    id: "human",
